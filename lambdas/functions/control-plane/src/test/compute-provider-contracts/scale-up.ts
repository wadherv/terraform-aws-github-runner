...
import type { ActionRequestMessageSQS, ScaleUpComputeProvider } from '../../scale-runners/types';

type TestScaleUpProvider<TType extends string> = Omit<ScaleUpComputeProvider, 'type'> & { type: TType };
